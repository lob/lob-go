...
*/
func (a *CreativesApiService) Create(ctx context.Context) ApiCreativeCreateRequest {
	return ApiCreativeCreateRequest{
		ApiService: a,
		ctx: ctx,
	}
...
*/
func (a *CreativesApiService) Get(ctx context.Context, crvId string) ApiCreativeRetrieveRequest {
	return ApiCreativeRetrieveRequest{
		ApiService: a,
		ctx: ctx,
		crvId: crvId,
...
*/
func (a *CreativesApiService) Update(ctx context.Context, crvId string) ApiCreativeUpdateRequest {
	return ApiCreativeUpdateRequest{
		ApiService: a,
		ctx: ctx,
		crvId: crvId,

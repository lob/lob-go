...
type NullableBillingGroupList struct {
	value *BillingGroupList
	isSet bool
}

func (v NullableBillingGroupList) Get() *BillingGroupList {
	return v.value
}

func (v *NullableBillingGroupList) Set(val *BillingGroupList) {
	v.value = val
	v.isSet = true
}
...
func NewNullableBillingGroupList(val *BillingGroupList) *NullableBillingGroupList {
	return &NullableBillingGroupList{value: val, isSet: true}
}

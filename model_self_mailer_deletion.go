...
func NewSelfMailerDeletion() *SelfMailerDeletion {
	this := SelfMailerDeletion{}
	var object string = "self_mailer_deleted"
	this.Object = &object
	return &this
}
...
type NullableSelfMailerDeletion struct {
	value *SelfMailerDeletion
	isSet bool
}

func (v NullableSelfMailerDeletion) Get() *SelfMailerDeletion {
	return v.value
}

func (v *NullableSelfMailerDeletion) Set(val *SelfMailerDeletion) {
	v.value = val
	v.isSet = true
}
...
func NewNullableSelfMailerDeletion(val *SelfMailerDeletion) *NullableSelfMailerDeletion {
	return &NullableSelfMailerDeletion{value: val, isSet: true}
}

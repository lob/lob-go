...
func NewPostcardDeletion() *PostcardDeletion {
	this := PostcardDeletion{}
	var object string = "postcard_deleted"
	this.Object = &object
	return &this
}
...
type NullablePostcardDeletion struct {
	value *PostcardDeletion
	isSet bool
}

func (v NullablePostcardDeletion) Get() *PostcardDeletion {
	return v.value
}

func (v *NullablePostcardDeletion) Set(val *PostcardDeletion) {
	v.value = val
	v.isSet = true
}
...
func NewNullablePostcardDeletion(val *PostcardDeletion) *NullablePostcardDeletion {
	return &NullablePostcardDeletion{value: val, isSet: true}
}

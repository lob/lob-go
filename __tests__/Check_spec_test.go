...
func (suite *CheckTestSuite) TestCheckCreate() {
	t := suite.T()
	resp, _, err := suite.apiClient.ChecksApi.CheckCreate(suite.ctx).CheckEditable(suite.checkEditable).Execute()
...
func (suite *CheckTestSuite) TestCheckCreateBadApiKey() {
	t := suite.T()
	_, _, err := suite.apiClient.ChecksApi.CheckCreate(suite.badctx).CheckEditable(suite.checkEditable).Execute()
...
func (suite *CheckTestSuite) TestCheckRetrieve() {
	t := suite.T()
	createdCheck, _, _ := suite.apiClient.ChecksApi.CheckCreate(suite.ctx).CheckEditable(suite.checkEditable).Execute()

	resp, _, err := suite.apiClient.ChecksApi.CheckRetrieve(suite.ctx, createdCheck.Id).Execute()
	assert.Nil(t, err)
	if assert.NotNil(t, resp) {
...
func (suite *CheckTestSuite) TestCheckRetrieveBadApiKey() {
	t := suite.T()
	_, _, err := suite.apiClient.ChecksApi.CheckRetrieve(suite.badctx, "fake id").Execute()
	if assert.NotNil(t, err) {
		assert.Equal(t, "401 Unauthorized", err.Error())
	}
}
...
func (suite *CheckTestSuite) TestCheckList() {
	t := suite.T()
	resp, _, err := suite.apiClient.ChecksApi.ChecksList(suite.ctx).Execute()
	assert.Nil(t, err)
	if assert.NotNil(t, resp) {
...
func (suite *CheckTestSuite) TestCheckListWithIncludeParameter() {
	t := suite.T()
	resp, _, err := suite.apiClient.ChecksApi.ChecksList(suite.ctx).Limit(3).Execute()
	assert.Nil(t, err)
	if assert.NotNil(t, resp) {
...
func (suite *CheckTestSuite) TestCheckListWithNextPageToken() {
	t := suite.T()
	firstResponse, _, firstErr := suite.apiClient.ChecksApi.ChecksList(suite.ctx).Limit(1).Execute()
	assert.Nil(t, firstErr)
	responeAfter, _, err := suite.apiClient.ChecksApi.ChecksList(suite.ctx).After(firstResponse.GetNextPageToken()).Execute()
	assert.Nil(t, err)
...
func (suite *CheckTestSuite) TestCheckListWithPrevPageToken() {
	...
	firstResponse, _, firstErr := suite.apiClient.ChecksApi.ChecksList(suite.ctx).Limit(1).Execute()
	assert.Nil(t, firstErr)
	responeAfter, _, errAfter := suite.apiClient.ChecksApi.ChecksList(suite.ctx).After(firstResponse.GetNextPageToken()).Execute()
	assert.Nil(t, errAfter)
	responseBefore, _, err := suite.apiClient.ChecksApi.ChecksList(suite.ctx).Before(responeAfter.GetPrevPageToken()).Execute()
	assert.Nil(t, err)
...
func (suite *CheckTestSuite) TestCheckCancel() {
	...
	resp, _, err := suite.apiClient.ChecksApi.CheckCancel(suite.ctx, createdCheck.Id).Execute()
	assert.Nil(t, err)
	if assert.NotNil(t, resp) {

...
`func NewValidationError(loc []AnyOfstringinteger, msg string, type_ string, ) *ValidationError`
...
`func (o *ValidationError) GetLoc() []AnyOfstringinteger`

GetLoc returns the Loc field if non-nil, zero value otherwise.

### GetLocOk

`func (o *ValidationError) GetLocOk() (*[]AnyOfstringinteger, bool)`
...
`func (o *ValidationError) SetLoc(v []AnyOfstringinteger)`

...
func (v NullableCampaignCreative) Get() *CampaignCreative {
	return v.value
}

func (v *NullableCampaignCreative) Set(val *CampaignCreative) {
	v.value = val
	v.isSet = true
}
...
func NewNullableCampaignCreative(val *CampaignCreative) *NullableCampaignCreative {
	return &NullableCampaignCreative{value: val, isSet: true}
}

...
const (
	PREPROCESSING UploadState = "Preprocessing"
	DRAFT UploadState = "Draft"
	READY_FOR_VALIDATION UploadState = "Ready for Validation"
	VALIDATING UploadState = "Validating"
	SCHEDULED UploadState = "Scheduled"
	CANCELLED UploadState = "Cancelled"
	ERRORED UploadState = "Errored"
)

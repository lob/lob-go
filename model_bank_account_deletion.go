...
func NewBankAccountDeletion() *BankAccountDeletion {
	this := BankAccountDeletion{}
	var object string = "bank_account_deleted"
	this.Object = &object
	return &this
}
...
type NullableBankAccountDeletion struct {
	value *BankAccountDeletion
	isSet bool
}

func (v NullableBankAccountDeletion) Get() *BankAccountDeletion {
	return v.value
}

func (v *NullableBankAccountDeletion) Set(val *BankAccountDeletion) {
	v.value = val
	v.isSet = true
}

func (v NullableBankAccountDeletion) IsSet() bool {
	return v.isSet
}
...
func NewNullableBankAccountDeletion(val *BankAccountDeletion) *NullableBankAccountDeletion {
	return &NullableBankAccountDeletion{value: val, isSet: true}
}
